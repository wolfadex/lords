...
var author$project$1$init = function (_v0) {
    ...
    if (snapshot != null) {
      try {
		...
		{
			game: $author$project$Main$MainMenu,
...
var $author$project$Main$updateMainMenu = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'CreateNewGame':
				return $laserpants$elm_update_pipeline$Update$Pipeline$save(
					_Utils_update(
						model,
						{
							game: $author$project$Main$NewGame(
								{image: '', name: ''})
						}));
			case 'SetName':
				return $laserpants$elm_update_pipeline$Update$Pipeline$save(model);
			case 'SetImage':
				return $laserpants$elm_update_pipeline$Update$Pipeline$save(model);
			default:
				return $laserpants$elm_update_pipeline$Update$Pipeline$save(model);
...
var $author$project$Main$updateNewGame = F3(
	function (msg, model, newGameModel) {
		switch (msg.$) {
			case 'CreateNewGame':
				return $laserpants$elm_update_pipeline$Update$Pipeline$save(model);
			case 'SetName':
					...
					_Utils_update(
						model,
						{
							game: $author$project$Main$Playing(
								{
									opossingKingdoms: _List_Nil,
									yourKingdom: {followers: 0, image: newGameModel.image, name: newGameModel.name}
								})
						}));
		}
	});
var $author$project$Main$updatePlaying = F3(
	function (msg, model, playingModel) {
		return $laserpants$elm_update_pipeline$Update$Pipeline$save(model);
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_v0.$) {
			case 'MainMenu':
				return A2($author$project$Main$updateMainMenu, msg, model);
			case 'NewGame':
				var m = _v0.a;
				return A3($author$project$Main$updateNewGame, msg, model, m);
			default:
				var m = _v0.a;
				return A3($author$project$Main$updatePlaying, msg, model, m);
		}
	});
...
var $author$project$Gui$Color$light = A3($mdgriffith$elm_ui$Element$rgb, 0.922, 0.922, 0.91);
var $author$project$Main$CreateNewGame = {$: 'CreateNewGame'};
...
var $author$project$Gui$Color$primary = A3($mdgriffith$elm_ui$Element$rgb, 0.467, 0.541, 0.208);
var $author$project$Gui$Color$secondary = A3($mdgriffith$elm_ui$Element$rgb, 0.82, 0.886, 0.769);
...
var $author$project$Gui$menuButton = function (_v0) {
	var label = _v0.label;
	var onPress = _v0.onPress;
	var color = _Utils_eq(onPress, $elm$core$Maybe$Nothing) ? $author$project$Gui$Color$secondary : $author$project$Gui$Color$primary;
	return A2(
...
var $author$project$Main$viewMainMenu = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('Lords')),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$author$project$Gui$menuButton(
					{
						label: 'New Game',
						onPress: $elm$core$Maybe$Just($author$project$Main$CreateNewGame)
					}),
					$author$project$Gui$menuButton(
					{label: 'Quit', onPress: $elm$core$Maybe$Nothing})
				]))
		]));
var $author$project$Main$BeginGame = {$: 'BeginGame'};
var $author$project$Main$SetImage = function (a) {
	return {$: 'SetImage', a: a};
};
...
var $author$project$Main$viewNewGame = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('What is your name?')),
					onChange: $author$project$Main$SetName,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Cthulhu'))),
					text: model.name
				}),
				A2(
				$mdgriffith$elm_ui$Element$Input$text,
				_List_Nil,
				{
					label: A2(
						$mdgriffith$elm_ui$Element$Input$labelAbove,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('What do you look like?')),
					onChange: $author$project$Main$SetImage,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('https://vignette.wikia.nocookie.net/lovecraft/images/c/cf/Screenshot_20171018-093500.jpg/revision/latest/scale-to-width-down/1000?cb=20171020174137'))),
					text: model.image
				}),
				A2(
				...
				{description: 'Image of you', src: model.image}),
				$author$project$Gui$menuButton(
				{
					label: 'Begin Your Reign',
					onPress: $elm$core$String$isEmpty(model.name) ? $elm$core$Maybe$Nothing : ($elm$core$String$isEmpty(model.image) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Main$BeginGame))
				})
			]));
};
var $author$project$Main$viewPlaying = function (model) {
	return $mdgriffith$elm_ui$Element$text('playing');
};
var $author$project$Main$viewGame = function (model) {
	...
	switch (_v0.$) {
		...
		case 'NewGame':
			var m = _v0.a;
			return $author$project$Main$viewNewGame(m);
		default:
			var m = _v0.a;
			return $author$project$Main$viewPlaying(m);
	}
};
			...
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$Background$color($author$project$Gui$Color$light)
					]),
